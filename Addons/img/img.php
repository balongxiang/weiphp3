...
class ImageWatermark{
    ...
    public $fontFile = 'msyh.ttf';   //字体文件名

    public $color = '#CCCCCC';        //水印字体的颜色

    public $fontSize = 20;            //水印字体大小
...
$markimg = new ImageWatermark('../View/default/image/zheng2.png');

$markimg->setMarkPos(151,96.5);//如何设置setMarkPos,则markPosType无效。

$markimg->markPosType=0;

$markimg->appendImageMark('http://127.0.0.1/weiphp3/Addons/Survey/View/default/image/zheng2.png');

$markimg->fontFile='msyh.ttf';

$markimg->color='#4C4C4C';

$markimg->fontSize=6.5;

$markimg->angle=0;//设置角度时，注意水印可能旋转出目标图片之外。
$aa ="爱asfa";
$markimg->appendTextMark($aa);
