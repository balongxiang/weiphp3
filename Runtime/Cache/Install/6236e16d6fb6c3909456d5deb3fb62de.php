...
<html>
    <head>
        ...
        <!-- Le styles -->
        <link href="/weiphp3/Public/static/bootstrap/css/bootstrap.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet">
        <link href="/weiphp3/Public/static/bootstrap/css/bootstrap-responsive.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet">
        <link href="/weiphp3/Public/Install/css/install.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet">

        <!-- Le HTML5 shim, for IE6-8 support of HTML5 elements -->
        <!--[if lt IE 9]>
            <script src="assets/js/html5shiv.js?v=<?php echo SITE_VERSION;?>"></script>
        <![endif]-->
        <script src="/weiphp3/Public/static/jquery-1.10.2.min.js"></script>
        <script src="/weiphp3/Public/static/bootstrap/js/bootstrap.js?v=<?php echo SITE_VERSION;?>"></script>
    </head>
            ...
            <div class="navbar-inner">
                <div class="container">
                    ...
                    <div class="nav-collapse collapse">
                    	<p class="install_logo"><span><img width="50px;" src="/weiphp3/Public/Install/img/install.png"/></span></p>
 ...
 defined('SAE_MYSQL_HOST_M') or define('SAE_MYSQL_HOST_M', '127.0.0.1'); defined('SAE_MYSQL_HOST_M') or define('SAE_MYSQL_PORT', '3306'); ?>
    <h1>创建数据库</h1>
    <form action="/weiphp3/install.php?s=/install/step2.html" method="post" target="_self">
