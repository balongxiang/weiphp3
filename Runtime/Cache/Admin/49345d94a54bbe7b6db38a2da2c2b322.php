...
<head>
	...
	<link rel="stylesheet" href="/weiphp3/Public/Admin/js/codemirror/codemirror.css">
	<link rel="stylesheet" href="/weiphp3/Public/Admin/js/codemirror/theme/<?php echo C('codemirror_theme');?>.css">
	<style>
		...
		#preview_window.loading{
			background: url('/weiphp3/Public/static/thinkbox/skin/default/tips_loading.gif') no-repeat center;
		}
...
<body>
	...
	<form id="form" action="<?php echo U('build');?>" method="post" class="form-horizontal doc-modal-form">
		...
		<div class="form-item">
			<label class="item-label">是否需要配置<span class="check-tips">（如插件有配置参数，则选择是，如：<a href="<?php echo addons_url ( 'UserCenter://UserCenter/config' );?>" target="_blank">微信用户插件的配置</a> ）</span></label>
			<div class="controls">
...
return array(
	...
	<script type="text/javascript" src="/weiphp3/Public/Admin/js/codemirror/codemirror.js?v=<?php echo SITE_VERSION;?>"></script>
	<script type="text/javascript" src="/weiphp3/Public/Admin/js/codemirror/xml.js?v=<?php echo SITE_VERSION;?>"></script>
	<script type="text/javascript" src="/weiphp3/Public/Admin/js/codemirror/javascript.js?v=<?php echo SITE_VERSION;?>"></script>
	<script type="text/javascript" src="/weiphp3/Public/Admin/js/codemirror/clike.js?v=<?php echo SITE_VERSION;?>"></script>
	<script type="text/javascript" src="/weiphp3/Public/Admin/js/codemirror/php.js?v=<?php echo SITE_VERSION;?>"></script>

	<script type="text/javascript" src="/weiphp3/Public/static/thinkbox/jquery.thinkbox.js?v=<?php echo SITE_VERSION;?>"></script>
